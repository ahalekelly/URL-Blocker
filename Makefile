...
help:
	...
	@printf "  make vivaldi-install         Build the Vivaldi main-profile extension; reload only if Vivaldi is open.\n"
	@printf "  make brave-install           Build the Brave main-profile extension; reload only if Brave is open.\n"
