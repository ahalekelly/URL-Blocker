...
help:
	...
	@printf "  make vivaldi-install         Build the Vivaldi extension; reload the running profile when open.\n"
	@printf "  make brave-install           Build the Brave extension; reload the running profile when open.\n"
